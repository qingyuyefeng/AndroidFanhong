...
public class BluetoothTools {
	 ...
	 * Action：显示语句
	 */
	public static final String ACTION_SHOW_BUFFER = "ACTION_SHOW_BUFFER";
	 ...
	 * Message：连接断开
	 */
	public static final int MESSAGE_CONNECT_BREAK = 0x00000007;

	/**
	 * Message：手机显示话语
	 */
	public static final int PHONE_SHOW_BUFFER = 0x00000008;
